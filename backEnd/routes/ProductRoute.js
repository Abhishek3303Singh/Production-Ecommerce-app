...
const {updateProduct, allProducts, addProduct, deleteProduct, productDetails, searchItem, productReview, getAllReviews, deleteReview, adminAllProducts, searchSuggestion} = require('../routeResponse/productResponse');
